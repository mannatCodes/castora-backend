...
def process_articles_for_embedding(tracking_db_path=None, groq_api_key=None, batch_size=20, delay_range=(1, 3)):
...
if __name__ == "__main__":
    ...
    if not api_key:
        print("Error: No OpenAI API key provided. Please provide via --api_key or set Groq_API_KEY in .env file")
        exit(1)
