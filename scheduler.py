...
def execute_task(task_id, command):
    ...
    print(f"\n==============================")
    print(f"TASK FUNCTION ENTERED: {task_id}")
    ...
    print(f"STEP 1: subprocess about to start")
    ...
    try:
        ...
        print(f"STEP 2: subprocess started, waiting for completion")

        try:
            stdout, stderr = process.communicate(timeout=DEFAULT_TASK_TIMEOUT)

            print(f"STEP 3: subprocess finished")
            ...
            print(f"STEP 3: TIMEOUT occurred")
        ...
        print(f"TASK END (FAILED): {task_id}")
